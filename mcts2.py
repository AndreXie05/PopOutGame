'''Dar prioridade a jogadas que ganham imediatamente <- for dentro no rollout'''
...
def rollout(state):
    ...
    while not current_state.is_terminal():
        ...
        for move in legal_moves:
            temp = current_state.apply_move(move)
            if temp.check_four_in_a_row(current_state.current_player):
                return 1
