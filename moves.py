...
class PopOutBoard:
    ...
    def get_result(self):
        # MCTS quer saber o resultado para o ponto de vista do jogador que acabou de jogar
        if self.check_four_in_a_row(1): return 1  # Vitória do Humano
        if self.check_four_in_a_row(2): return -1 # Vitória da IA
        return 0 # Empate